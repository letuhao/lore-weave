...
import { EDITOR_TOUR_CATALOG } from '../onboarding/tourCatalog';
...
export function UserGuidePanel(props: IDockviewPanelProps) {
  ...
  // #19 Wave 3 — the editor deep-dive tours (docs/specs/2026-07-06-editor-feature-inventory.md)
  // are grouped by feature topic rather than one long walkthrough; this is their ONE discoverable
  // entry point (the animated tour was previously reachable only via the Command Palette shortcut,
  // with no visible list of what tours even exist).
  ...
  return (
    <div data-testid="studio-user-guide-panel" className="h-full min-h-0 overflow-y-auto p-4">
      ...
      <section data-testid="studio-user-guide-tours" className="mb-6">
