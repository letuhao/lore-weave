...
/**
 * Fetches and caches the list of entity kinds for the lifetime of the component.
 * Kinds are static seed data — no refetch needed beyond mount.
 */
export function useEntityKinds(): State {
