...
const KINDS = ['extraction', 'glossary_extraction', 'wiki_gen', 'translation', 'glossary_translation', 'composition.generate', 'video_gen', 'campaign', 'enrichment_job', 'book_import'];
