...
// 14_kg_panels.md A2 — extracted from ProjectsTab (DOCK-2/DOCK-7) so the SAME browsing
// logic (search/sort/filter/create/archive/delete) is shared by the classic `/knowledge`
// route (ProjectsTab, which navigates on row-open) AND the studio `knowledge` dock panel
// (KnowledgeHubPanel, which opens via the studio link resolver instead of navigate()).
