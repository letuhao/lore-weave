...
describe('i18n keys cover every ProjectStateKind + every action + every card body key in every locale', () => {
  ...
  const TIMELINE_KEYS = [
    ...
    'filters.project',
    'filters.anyProject',
    // C10 — TimelineFilters entity picker + chronological range
    'filters.entity',
    'filters.entityPlaceholder',
    'filters.entitySearchMinHint',
    'filters.entityNoMatches',
    'filters.clearEntity',
    'filters.chronologicalRange',
    'filters.after',
    'filters.before',
    'filters.chronoReversed',
    'row.orderLabel',
    'row.noOrder',
    'row.chapterLabel',
