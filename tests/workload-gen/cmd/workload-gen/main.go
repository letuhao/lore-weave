...
func main() {
	...
	os.Exit(run(os.Stdout, *seed, *profile, *doEmit, *doVerify, *doCheckProj, *dsn))
}

func run(out io.Writer, seed int64, profileName string, doEmit, doVerify, doCheckProj bool, dsn string) int {
