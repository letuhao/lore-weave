...
from app.api import book_profile, compose, gaps, jobs, observability, proposals, sources, templates
...
app.include_router(compose.router)  # Compose — unified async input modes (slice 1: gap|draft)
