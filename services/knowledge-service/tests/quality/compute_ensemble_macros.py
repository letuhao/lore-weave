...
# Overridable via env so the exclusion travels with config, not code.
_DEFAULT_EXTRACTOR_UUID = "019e6a20-eeac-7b96-82ee-69a16d8ef68d"  # qwen-30b extractor
_DEFAULT_FILTER_UUID = "019e5650-eca7-78c2-985d-465aa3bce1ce"  # qwen3.6-35b filter
...
def main() -> int:
    ...
    extractor = os.environ.get("KNOWLEDGE_EXTRACTOR_MODEL", _DEFAULT_EXTRACTOR_UUID)
    filt = os.environ.get("KNOWLEDGE_FILTER_MODEL", _DEFAULT_FILTER_UUID)
    n_boot = int(os.environ.get("KNOWLEDGE_BOOTSTRAP_N", "2000") or 2000)
    excluded = {extractor, filt}
