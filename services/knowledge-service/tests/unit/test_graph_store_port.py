...
def test_implementations_match_the_port_signatures(impl):
    ...
    for name in ("resolve_or_merge_entity", "find_entities_by_name", "neighborhood",
                 ...
                 # A2 — the event corrections. AGE REFUSES two of these (NotImplementedError,
                 # D-AGE-EVENT-WRITE-UNIMPLEMENTED) but must still match the SHAPE, or a
                 # future implementation would be free to invent a different one.
