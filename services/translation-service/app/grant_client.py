...
shared SDK; this module keeps translation-service's singleton + settings wiring so
existing ``from app.grant_client import ...`` call sites are unchanged. The
re-exports preserve a single GrantLevel identity across services.
"""
