...
SUPPORTED_OPERATIONS: frozenset[str] = frozenset(
    {"decompose_preview", "plan_pipeline", "stitch_chapter", "generate", "chapter_generate",
     ...
     # The user-paid motif translate (Tier-W). Retryable: the confirm effect persists the
     # full envelope (motif_ids + target + model), and the engine re-checks tenancy on
     # every run rather than trusting the proposal.
     "translate_motif",
