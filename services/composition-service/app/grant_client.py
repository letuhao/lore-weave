...
SDK and the knowledge-service / translation-service copies.
...
NOTE (E0-4c): this is the 4th copy of the SDK (Go + knowledge + translation +
here). With all three Python adopters now live, extraction into a shared
``sdks/python/loreweave_grants`` is due — see D-E0-4-PY-GRANT-SDK-EXTRACT.
"""
