...
func main() {
	slog.SetDefault(slog.New(slog.NewJSONHandler(os.Stdout, nil)).With("service", "usage-billing-service"))
	...
	shutdownTracer, err := observability.InitTracer(context.Background(), "usage-billing-service")
	if err != nil {
