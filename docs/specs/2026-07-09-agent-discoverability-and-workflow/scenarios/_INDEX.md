...
|---|---|---|---|---|---|---|---|
| [S01](S01-glossary-bootstrap.md) | Suggest & set up a glossary/ontology for a book | P2 Linh | write | **P0** | no (existing tools) | 🔬 baseline ❌ 2026-07-10 — entities-before-kinds; `propose_entities` silent-success (`ok:true`, all items errored) → 5× retry; `book_kinds=0` | this session |
...
| [S03](S03-entity-triage.md) | Triage the entity inbox (approve / reject / merge / edit) | P2 Linh | write | P0 | no | 🔬 baseline ❌ 2026-07-10 — inbox hides the pile behind an `ai-suggested` tag (3602 untagged drafts); 26→26; false "all clean" | this session |
