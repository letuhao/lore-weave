...
|---|---|---|---|---|---|---|---|
| [S01](S01-glossary-bootstrap.md) | Suggest & set up a glossary/ontology for a book | P2 Linh | write | **P0** | no (existing tools) | 🔬 ❌ (baseline 2026-07-10 · re-test 2026-07-11 unchanged) — entities-before-kinds; `propose_entities` silent-success → 9× loop; `book_kinds=0`. Needs WS-5 rail + silent-success fix. | this session |
