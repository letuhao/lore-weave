...
|---|---|---|---|---|---|---|---|
| [S01](S01-glossary-bootstrap.md) | Suggest & set up a glossary/ontology for a book | P2 Linh | write | **P0** | no (existing tools) | 🟢 **~75% ✅ (WS-5 2026-07-11)** — `glossary-bootstrap` rail + steering directive → gemma follows list→adopt→confirm; `book_kinds` 0→10-13. Silent-success fixed. Remaining ~25%: model stalls before confirm. | this session |
...
| [S03](S03-entity-triage.md) | Triage the entity inbox (approve / reject / merge / edit) | P2 Linh | write | P0 | no | 🔬 ❌ (baseline 2026-07-10 · re-test 2026-07-11 worse) — inbox hides untagged drafts; agent now *creates* 14 during cleanup (26→27), 0 chars to user | this session |
