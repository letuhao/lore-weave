...
| **B · Domain backend** ([brief](TRACK-B.md)) | *this session* | WS-4A ✅ · rename ✅ · WS-4B ✅ · WS-4C Half B ✅ (facts→L2) · **WS-4C Half A ✅** ([spec](../../2026-07-10-ws4c-half-a-canon-auto-capture.md) — chat→glossary `capture-canon`, grant-checked, drafts into the `ai-suggested` inbox; 3-service live smoke) · domain fixes ✅ · **defers empty**. Remaining: W8/W10/W11 product-journey backends (P2, own design pass) | 🔄 |
