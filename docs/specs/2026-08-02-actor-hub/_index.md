...
**Run state:** [`../../plans/2026-08-02-actor-substrate-RUN-STATE.md`](../../plans/2026-08-02-actor-substrate-RUN-STATE.md) — `D-1`..`D-372`
...
| [`analysis/2026-08-02-actor-data-structure.md`](analysis/2026-08-02-actor-data-structure.md) | the earliest decision record (`D-1`..`D-372` era) plus the first red-team round. **Predates the plugin frame entirely** |
