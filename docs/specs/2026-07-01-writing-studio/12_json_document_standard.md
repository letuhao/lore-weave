...
Chapter editor (↑cycle 1, ✅ built) → **Glossary (📐 specced — re-scoped as shared-foundation-then-fanout,
see [`13_glossary_panels.md`](13_glossary_panels.md); too large for a flat single-cycle, 7 sub-features)**
→ Wiki → Knowledge/Ontology → Translation (job-based — gate needs the job-terminal→refresh path) →
