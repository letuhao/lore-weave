...
4. **C-adopt** — composition attaches `GroundingCite`s to packed entities/lore (per-item grounding it lacks today) via the SDK adapters. **← NEXT** (the last mui#3 phase).
