...
- **composition:** `composition_get_work`, `composition_list_outline`, `composition_get_prose`, `composition_list_canon_rules`, `composition_get_generation_job`
...
- **composition:** `composition_create_work`* (idempotent ✓), outline_node create*/update/delete/restore, scene_link create*/delete, canon_rule create*/update/delete, `composition_write_prose` (version-checked ✓)
