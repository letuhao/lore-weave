...
**Status:** Part A SHIPPED 2026-07-07 (lint + fixes below); Parts B/C/D/E still DRAFT, PO-decided in §11. **Size:** XL (cross-service standard, touches every future domain skill)
