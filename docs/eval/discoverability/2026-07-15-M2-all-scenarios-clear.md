...
| S09 | canon-check | 1/3 — **D-S09-CANON-PROJECT-RESOLUTION** | fixture fixed (rule seeded); r3 drove full conformance; tools need book_id-resolution (tracked) |
