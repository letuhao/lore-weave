...
| **5f** (next) | video-gen-service deletion + api-gateway-bff `/v1/video-gen/*` route retirement + FE migration. After this: unified-gateway invariant fully realized for chat + extraction + translation + audio + image + video. | M |
