...
| [`16_book_scale_ab.md`](16_book_scale_ab.md) | **the book-scale A/B** — cost −65.5% confirmed on the real pipeline, coverage −38.4% concentrated in the rare kinds, and `15`'s ship-it recommendation WITHDRAWN |
