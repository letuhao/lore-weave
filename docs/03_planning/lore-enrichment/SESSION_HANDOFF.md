...
> **NEXT (Cluster 2 remaining):** D1 gap-auto-detect · resume/051 · corpus-register — each its own CLARIFY/DESIGN/PLAN. Then Cluster 3 (C1 token metering · C3 auto-reject design). C2 judge-diversity PARKED until main merges.
