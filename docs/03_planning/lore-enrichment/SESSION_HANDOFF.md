...
> **NEXT:** Cluster 2 (wire D1 gap-auto-detect · resume/051 · corpus-register · F-LIVE-1 stale-image guard) — each needs its own CLARIFY/DESIGN/PLAN. Then Cluster 3 (C1 token metering · C3 auto-reject design). C2 PARKED until main merges.
