...
| Changes a PC-* rule | `_superseded/04_player_character/<section>.md` | Adjust PC-B1 death behavior default |
...
**Rule of thumb:** if the feature is "consume kernel and deliver user value", it goes in `catalog/`, `_superseded/04_player_character/`, or a new DF doc. If it's "change how services integrate", it's kernel work.
...
| PC death → NPC conversion | `02_storage/R08_npc_memory_split.md` · `03_multiverse/06_M_C_resolutions.md` (§9.9 severance if applicable) · `_superseded/04_player_character/04_lifecycle.md` · `decisions/deferred_DF01_DF15.md` (DF1/DF4) |
