...
| `SR1..SR12` | SRE review concerns | [`02_storage/SR01..SR11_*.md`](../02_storage/_index.md) | SR12 not yet designed | SR11 = Turn-based game reliability UX (2026-04-24; vocabulary additions `TurnState` + `PresenceState` architect-approved) |
| `SR*-D*` | Per-SR decision numbers | same | next free per SR | SR11-D1..D10 |
...
| `IF-1..IF-44` (+ `-a..-j` sub-chains) | Infrastructure features | [`catalog/cat_01_IF_infrastructure.md`](../catalog/cat_01_IF_infrastructure.md) | IF-45+ | IF-31 = SVID (S11) · IF-32 = WebSocket (S12) · IF-39 = Dependency registry (SR6) · IF-40 = Chaos registry (SR7) · IF-41 = Capacity budget registry (SR8) · IF-42 = Alert rule registry (SR9) · IF-43 = Supply chain registry (SR10) · IF-44 = Turn state machine (SR11) |
