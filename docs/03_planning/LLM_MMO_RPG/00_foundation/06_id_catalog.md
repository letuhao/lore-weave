...
| `SR1..SR12` | SRE review concerns | [`02_storage/SR01..SR10_*.md`](../02_storage/_index.md) | SR11..SR12 not yet designed | SR10 = Supply chain security (2026-04-24; I18 approved) |
| `SR*-D*` | Per-SR decision numbers | same | next free per SR | SR10-D1..D11 |
...
| `IF-1..IF-43` (+ `-a..-j` sub-chains) | Infrastructure features | [`catalog/cat_01_IF_infrastructure.md`](../catalog/cat_01_IF_infrastructure.md) | IF-44+ | IF-31 = SVID (S11) · IF-32 = WebSocket (S12) · IF-39 = Dependency registry (SR6) · IF-40 = Chaos registry (SR7) · IF-41 = Capacity budget registry (SR8) · IF-42 = Alert rule registry (SR9) · IF-43 = Supply chain registry (SR10) |
