...
| `SR1..SR12` | SRE review concerns | [`02_storage/SR01..SR08_*.md`](../02_storage/_index.md) | SR9..SR12 not yet designed | SR8 = Capacity planning + auto-scaling (2026-04-24; I17 approved) |
| `SR*-D*` | Per-SR decision numbers | same | next free per SR | SR8-D1..D11 |
...
| `IF-1..IF-41` (+ `-a..-j` sub-chains) | Infrastructure features | [`catalog/cat_01_IF_infrastructure.md`](../catalog/cat_01_IF_infrastructure.md) | IF-42+ | IF-31 = SVID (S11) · IF-32 = WebSocket (S12) · IF-39 = Dependency registry (SR6) · IF-40 = Chaos registry (SR7) · IF-41 = Capacity budget registry (SR8) |
