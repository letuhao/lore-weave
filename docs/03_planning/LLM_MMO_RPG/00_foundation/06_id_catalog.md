...
| `SR1..SR12` | SRE review concerns | [`02_storage/SR01..SR09_*.md`](../02_storage/_index.md) | SR10..SR12 not yet designed | SR9 = Alert tuning + pager discipline (2026-04-24) |
| `SR*-D*` | Per-SR decision numbers | same | next free per SR | SR9-D1..D10 |
...
| `IF-1..IF-42` (+ `-a..-j` sub-chains) | Infrastructure features | [`catalog/cat_01_IF_infrastructure.md`](../catalog/cat_01_IF_infrastructure.md) | IF-43+ | IF-31 = SVID (S11) · IF-32 = WebSocket (S12) · IF-39 = Dependency registry (SR6) · IF-40 = Chaos registry (SR7) · IF-41 = Capacity budget registry (SR8) · IF-42 = Alert rule registry (SR9) |
