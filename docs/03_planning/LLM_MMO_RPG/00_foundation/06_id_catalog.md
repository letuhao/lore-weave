...
| `SR1..SR12` | SRE review concerns | [`02_storage/SR01..SR06_*.md`](../02_storage/_index.md) | SR7..SR12 not yet designed | SR6 = Dependency failure handling (2026-04-24) |
| `SR*-D*` | Per-SR decision numbers | same | next free per SR | SR6-D1..D10 |
...
| `IF-1..IF-39` (+ `-a..-j` sub-chains) | Infrastructure features | [`catalog/cat_01_IF_infrastructure.md`](../catalog/cat_01_IF_infrastructure.md) | IF-40+ | IF-31 = SVID (S11) · IF-32 = WebSocket (S12) · IF-39 = Dependency registry (SR6) |
