...
| DL-5 | World simulation tick — 3-mode framework (frozen V1 default / lazy-when-visited V2 / scheduled V3), per-reality World Rule configurable, daily budget cap, platform-tier aware | ✅ | V1 (frozen) · V2 (lazy) · V3 (scheduled) | DF4 World Rules | [01 B3](../01_problems/B_distributed_systems.md#b3-world-simulation-tick--partial), B3-D1..D5 |
