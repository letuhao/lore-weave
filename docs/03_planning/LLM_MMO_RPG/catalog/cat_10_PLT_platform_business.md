...
|---|---|---|---|---|---|
| PLT-1 | Tier system — 3 tiers (Free BYOK / Paid platform-LLM / Premium) with feature gating mapped to B3/M1/M7/PC-C1/G3 | ✅ | PLT | PO-1 | [01 §D2](../01_problems/D_economics.md#d2-tier-viability--partial), D2-D1/D4; [103_PLATFORM_MODE_PLAN](../../103_PLATFORM_MODE_PLAN.md) |
...
| PLT-6 | Scheduled event hosting (author/platform timed events in popular realities) | 📦 | V2 | DF5, PL-1 | [01 §C3](../01_problems/C_product_ux.md#c3-cold-start-empty-world-problem--partial), C3-D4 |
...
| PLT-7 | IP / ToS / DMCA workflow | ❓ | PLT | — | [01 E3/E4](../01_problems/_index.md) |
