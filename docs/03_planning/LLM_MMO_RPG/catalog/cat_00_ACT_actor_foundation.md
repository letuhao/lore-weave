...
| ACT-20 | `CanonicalActorDecl` shape (V1 LOCKED 2026-04-27 P2 — spawn_cell + glossary_entity_id REQUIRED V1 fields ADDED to canonical seed declaration; populates ActorCore.current_region_id + ActorCore.glossary_entity_id at bootstrap; +2 V1 reject rules `actor.spawn_cell_unknown` + `actor.glossary_entity_unknown`; **boundary §2 update DEFERRED to Phase 2 P2 follow-up** when boundary lock free) | ⚠ Phase 1 ACT_001 spec done; Phase 2 boundary §2 deferred | V1 | ACT-1, EF-1, PF-1 (places) | [ACT_001 §10](../features/00_actor/ACT_001_actor_foundation.md#10-cross-service-handoff-canonical-seed-flow) + [ACT_001 §16](../features/00_actor/ACT_001_actor_foundation.md#16-boundary-registrations-in-same-commit-chain) |
