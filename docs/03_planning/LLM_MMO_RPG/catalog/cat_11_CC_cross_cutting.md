...
|---|---|---|---|---|---|
| CC-1 | Chat GUI extension — region sidebar, player list, NPC panel, action bar, dual stream | 🟡 | V1 | PL-1 | [03 §9.1, feature comparison doc](../03_multiverse/05_product_ux_basics.md) |
