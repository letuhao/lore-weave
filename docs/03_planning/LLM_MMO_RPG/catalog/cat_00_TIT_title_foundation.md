...
| TIT-18 | RejectReason `title.*` namespace (7 V1 rule_ids + 5 V1+ reservations) | ✅ | V1 | RES-* (i18n contract) | [TIT_001 §8](../features/00_titles/TIT_001_title_foundation.md#8--v1-reject-rules-title-namespace) + [`_boundaries/02_extension_contracts.md` §1.4](../_boundaries/02_extension_contracts.md) |
