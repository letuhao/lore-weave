...
| 01 | [cat_01_IF_infrastructure.md](cat_01_IF_infrastructure.md) | IF — Infrastructure | 355 | IF-1..IF-45 (+ IF-*-sub; IF-39 via SR6, IF-40 via SR7, IF-41 via SR8, IF-42 via SR9, IF-43 via SR10, IF-44 via SR11, IF-45 via SR12; all 2026-04-24) | 199 |
...
**Totals:** 14 chunks · 669 lines from original split + IF-39..IF-45j sub-chains (SR6/SR7/SR8/SR9/SR10/SR11/SR12, all 2026-04-24) · **474 features** across 12 categories (**362 Designed** · 39 Partial · **68 Deferred** · 3 Open · 2 out-of-scope). IF-39g reclassified V1+30d → V1 via SR7 activation; IF-41h + IF-41i + IF-42i + IF-43i are V1+30d deferred; IF-45f is split V1 + V1+30d. SR11 added new UX territory via IF-44 features; SR12 completes SRE review 12/12 with IF-45 observability discipline.
