...
| 01 | [cat_01_IF_infrastructure.md](cat_01_IF_infrastructure.md) | IF — Infrastructure | 322 | IF-1..IF-42 (+ IF-*-sub; IF-39 via SR6, IF-40 via SR7, IF-41 via SR8, IF-42 via SR9; all 2026-04-24) | 166 |
...
**Totals:** 14 chunks · 669 lines from original split + IF-39..IF-42j sub-chains (SR6/SR7/SR8/SR9, all 2026-04-24) · **441 features** across 12 categories (**331 Designed** · 38 Partial · **67 Deferred** · 3 Open · 2 out-of-scope). IF-39g reclassified V1+30d → V1 via SR7 activation; IF-41h + IF-41i + IF-42i are V1+30d deferred.
