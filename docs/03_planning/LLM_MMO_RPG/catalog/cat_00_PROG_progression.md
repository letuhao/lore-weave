...
- **CULT_001 Cultivation Foundation — V2+ ENTIRELY DEFERRED** (2026-04-27 stress-test correction): originally listed as V1+ priority per IDF closure roadmap; revised to V2+ template/convention library (non-engine, out-of-features/ folder) after stress-test against 11 exotic cultivation systems (Tiên Nghịch / Đấu Phá / Phàm Nhân / Tru Tiên / Cầu Ma / Hoàn Mỹ / Kim Dung wuxia / modern / sci-fi cyber) confirmed PROG-A1 axiom violation if engine hardcodes wuxia realms. Each reality has different realm hierarchy + stat axes + power scaling — author declares per-reality via existing PROG_001 ProgressionKindDecl + TierDecl + I18nBundle + canonical_traits Spirit Root + cross-aggregate validators. PROG_001 V1 sufficient for ALL cultivation realities without CULT_001. V2+ ships templates only after V1 author feedback. References to "V1+ CULT_001" in REP_001/FAC_001/FF_001/IDF/AIT_001/TDIL_001 reference docs become "V2+ CULT_001" naturally; deferral semantics unchanged. See [PROG_001 §14.15](../features/00_progression/PROG_001_progression_foundation.md#1415-cult_001-cultivation-foundation--v2-entirely-deferred-2026-04-27-stress-test-correction) for full V2+ defer rationale.
