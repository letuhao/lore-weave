...
| WA-2 | Reality creation by author (first-reality-of-book = fresh seed) | 🟡 | V1 | IF-3 | [03 §5](../03_multiverse/02_lifecycle_and_seeding.md) |
| WA-3 | Canon lock level per attribute (L1 axiomatic vs L2 seeded) | ✅ | V1 | — | [03 §3](../03_multiverse/01_four_layer_canon.md), MV1 locked |
| WA-4 | Category-based L1 auto-assignment (magic-system, species → L1) | ✅ | V1 | WA-3 | [03 §3 "Category heuristics"](../03_multiverse/01_four_layer_canon.md); WA4-D1..D5 locked 2026-04-24 |
