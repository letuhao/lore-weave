...
|---|---|---|---|---|---|
| PCS-1 | PC state projection (location, status, stats, inventory) | ✅ | V1 | IF-1 | [02 §5.1](../02_storage/00_overview_and_schema.md), [04 §8](../_superseded/04_player_character/08_data_model.md) |
| PCS-2 | PC inventory + item origin reality | ✅ | V1 | PCS-1 | [02 §5.1](../02_storage/00_overview_and_schema.md) (MV5 primitive P5) |
| PCS-3 | PC ↔ NPC relationship tracking | 🟡 | V1 | PCS-1 | [02 §5.1](../02_storage/00_overview_and_schema.md) |
| PCS-4 | PC stats model (simple state-based, no RPG mechanics) | 🟡 | V1 | PCS-1 | [04 §5.3](../_superseded/04_player_character/05_identity_and_agency.md), PC-C3 locked, **DF7** concrete schema |
| PCS-5 | PC offline mode (visible + vulnerable) | 🟡 | V1 | PCS-1 | [04 §4.2](../_superseded/04_player_character/04_lifecycle.md), PC-B2 locked |
| PCS-6 | PC `/hide` command + hidden status | 🟡 | V1 | PCS-5 | [04 §4.2](../_superseded/04_player_character/04_lifecycle.md) |
| PCS-7 | PC-as-NPC conversion after prolonged hiding | 📦 | V2 | PCS-6, NPC-8 | **DF1 — Daily Life** |
| PCS-8 | PC death (event emission, per-reality outcome) | 🟡 | V1 | PCS-1, WA-5 | [04 §4.1](../_superseded/04_player_character/04_lifecycle.md), PC-B1 locked; outcomes in **DF4** |
