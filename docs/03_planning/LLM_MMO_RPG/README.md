...
| [`_superseded/04_player_character/`](_superseded/04_player_character/) | PC semantics — identity layering (User/PC/Session), PC vs NPC rules, creation/lifecycle/social/canon decisions. Registers DF1–DF8 deferred big features. **Split into 11 chunks on 2026-04-24**; start at [`_superseded/04_player_character/_index.md`](_superseded/04_player_character/_index.md). Monolith archived at `04_PLAYER_CHARACTER_DESIGN.ARCHIVED.md`. |
...
9. [`_superseded/04_player_character/`](_superseded/04_player_character/) — PC semantics + deferred big features registry. Start at [`_index.md`](_superseded/04_player_character/_index.md).
