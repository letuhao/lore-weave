...
pub struct RealityManifest {
    ...
    //         MergeProvinces / SplitProvince / TransferProvinceToState / SetCultureRegion — closed-enum
    //         bump per R3 additive; +1 V2+ reservation: SetResourceOverride V2+ when GEO-D10 ships),
