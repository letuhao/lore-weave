...
> **Status:** **CANDIDATE-LOCK 2026-04-27** (DRAFT 2026-04-27 → Phase 3 cleanup 2026-04-27 → CANDIDATE-LOCK 2026-04-27 closure pass: §19 acceptance criteria walked AC-DF5-1..25; 4 Phase 3 fixes applied — LeftReason 6→7 variants + 14th rule_id participant_already_joined + boundary file consistency + AC walkthrough). Q1-Q12 ALL LOCKED via 4-batch deep-dive 2026-04-27 (zero revisions). Section 16 SDK Architecture LOCKED. 11 invariants DF5-A1..A11 codified. Companion: [`00_CONCEPT_NOTES.md`](00_CONCEPT_NOTES.md).
