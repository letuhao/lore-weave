...
- [`TDIL_001`](../17_time_dilation/TDIL_001_time_dilation_foundation.md) — per-segment selective clock advancement
...
- [`EF_001`](../00_entity/EF_001_entity_foundation.md) — `entity.travel_journey_id` reused per-segment (no new EF_001 field)
