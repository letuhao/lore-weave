...
- [`TDIL_001`](../17_time_dilation/TDIL_001_time_dilation_foundation.md) — encounter `fiction_duration` advances actor + body clocks
- [`AIT_001`](../16_ai_tier/AIT_001_ai_tier_foundation.md) — Tracked discipline; abstract (non-AIT) participants
