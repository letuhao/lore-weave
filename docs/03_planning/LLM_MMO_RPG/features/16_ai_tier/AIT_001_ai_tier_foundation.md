...
> **Status:** **CANDIDATE-LOCK 2026-04-27** (DRAFT 88404f08 → TDIL closure-pass-extension §7.5 O(1) revision applied at TDIL DRAFT bdc8d8e1 → DF5 closure-pass-extension annotation 5e9233d8 → CANDIDATE-LOCK 2026-04-27 closure pass: §16 AC-AIT-1..12 walked; AIT-Q1 + AIT-Q2 resolved as deferrals — AIT-Q1 deferred to PL_005 closure as new AIT-D-N (Stage 2 LLM-flavor synthesis prompt structure ownership transfer to PL_005 — consumer feature owns trigger), AIT-Q2 marked OUT-OF-SCOPE for AIT_001 (UntrackedRuntimeState ephemeral storage = DP-engineering choice; deferred to DP team closure). All 12 critical scope questions LOCKED via 4-batch deep-dive 2026-04-26..27 (Q1+Q2 / Q4+Q5+Q11 / Q6+Q12 / Q7+Q8+Q9; Q3 + Q10 implicit). Companion: [`00_CONCEPT_NOTES.md`](00_CONCEPT_NOTES.md) (concept + Q1-Q12 LOCKED matrix §16).
>
...
|---|---|---|
| ~~AIT-Q1~~ | ~~Stage 2 LLM-flavor synthesis prompt structure~~ | **✅ RESOLVED 2026-04-27 at CANDIDATE-LOCK closure** — deferred to PL_005 closure as new AIT-D21 V1+30d. PL_005 owns the trigger (Examine/Speak/Strike target = Untracked NPC fires Stage 2 synthesis); prompt structure designed at PL_005 closure pass alongside other LLM-call patterns. Token budget per call: ~500 tokens (Stage 1 template fields + Untracked role + cell context). |
| ~~AIT-Q2~~ | ~~UntrackedRuntimeState ephemeral storage location~~ | **✅ RESOLVED 2026-04-27 at CANDIDATE-LOCK closure** — OUT-OF-SCOPE for AIT_001; pure DP-engineering choice. Deferred to DP-team closure (06_data_plane). Recommended starter: session memory cache (in-process per session-service) since Untracked discard at session-end per Q6 LOCKED; Redis Streams ephemeral V2+ if cross-service Untracked observation needed. |
