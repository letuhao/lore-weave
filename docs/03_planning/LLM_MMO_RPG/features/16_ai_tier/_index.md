...
**Folder closure status:** **COMPLETE 2026-04-27** — AIT_001 **CANDIDATE-LOCK 2026-04-27** (DRAFT 88404f08 → TDIL closure-pass-extension §7.5 O(1) revision applied at TDIL DRAFT bdc8d8e1 → DF5 closure-pass-extension annotation 5e9233d8 → CANDIDATE-LOCK closure pass single combined `[boundaries-lock-claim+release]` commit). Q1-Q12 ALL LOCKED via 4-batch deep-dive (zero revisions). 27 V1 catalog entries AIT-1..AIT-27 + 7 V1+30d/V2 deferrals AIT-28..AIT-34. 10 axioms AIT-A1..A10. 8 V1 + 4 V1+ reject rule_ids in `ai_tier.*` namespace. 5 RealityManifest extensions OPTIONAL V1. **AIT-Q1 + AIT-Q2 RESOLVED at closure**: AIT-Q1 deferred to PL_005 closure as AIT-D21 V1+30d (Stage 2 LLM-flavor synthesis prompt structure ownership transfer to PL_005); AIT-Q2 marked OUT-OF-SCOPE (DP-engineering choice; recommended starter session memory cache). 12 V1-testable AC-AIT-1..12. **§7.5 Tracked NPC lazy materialization** revised at TDIL DRAFT to O(1) elapsed-time computation per TDIL-A3 + TDIL-A7. Cross-feature closure-pass-extensions to NPC_001 / NPC_002 / PCS_001 / PL_005 / WA_003 already applied (DF05 closure-pass cascade `5e9233d8`).

**LOCK target after** AC-AIT-1..12 V1-testable scenarios pass integration tests + V1+ AIT-D1/D2/D7/D21 ship (auto-promotion + demotion + LLM-propose-promotion + Stage 2 synthesis prompt — V1+30d items).
