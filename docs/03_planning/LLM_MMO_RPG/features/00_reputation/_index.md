...
**Active:** REP_001 — **Reputation Foundation** (DRAFT 2026-04-27 — commit 2/4 `[boundaries-lock-claim]` DRAFT promotion + boundary register)

**Folder closure status:** **OPEN** — Phase 0 (6b7d931) → commit 1/4 Q-lock (61e5019) → commit 2/4 DRAFT (this commit) → commit 3/4 Phase 3 cleanup → commit 4/4 closure + lock release. Resolves FAC-D7.
