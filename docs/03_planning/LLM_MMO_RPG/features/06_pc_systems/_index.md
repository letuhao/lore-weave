...
**Active:** PCS_001 — **PC Substrate** (DRAFT 2026-04-27 — commit 2/4 `[boundaries-lock-claim]` DRAFT promotion + boundary register; commits 3-4/4 next)

**Folder closure status:** **OPEN** — Phase 0 (3c76f33) → commit 1/4 Q-LOCKED + rename (5c34b93) → commit 2/4 DRAFT + boundary register (this commit) → commit 3/4 Phase 3 cleanup → commit 4/4 closure + lock release.
