...
**Active:** FAC_001 — **Faction Foundation** (CANDIDATE-LOCK 2026-04-26 — 4-commit cycle complete: Q-lock 49a17ed + DRAFT 89f1473 + Phase 3 120d5fe + closure 4/4 this commit)

**Folder closure status:** **COMPLETE 2026-04-26** — FAC_001 at CANDIDATE-LOCK. Folder ready. Resolves IDF_005 IDL-D2 + FF_001 FF-D7. Next priority: REP_001 Reputation Foundation (per-(actor, faction) reputation projection).
