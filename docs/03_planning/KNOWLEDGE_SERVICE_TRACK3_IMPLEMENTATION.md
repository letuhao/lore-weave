...
| K19a.6 ProjectEditor extension | ⏭️ NEXT | — | Change embedding model dialog + disable-without-delete + budget field. Replaces `onChangeModel`, `onDisable` toast-stubs. Pattern (dialog state lift + actions merge) established by K19a.5. |
