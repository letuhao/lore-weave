---
runbook_id: deploy/rollback-execution
version: 1
owner: sre-team
applies_to_alerts: [LWDeployRollbackTriggered]
applies_to_incidents: []
applies_to_services: [api-gateway-bff]
...
related_runbooks: []
external_access_needed: [aws_cloudwatch_logs, github_actions_admin]
...
- Alert(s) firing: `LWDeployRollbackTriggered`
...
admin-cli deploy status --dry-run
```
