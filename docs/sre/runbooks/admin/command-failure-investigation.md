---
runbook_id: admin/command-failure-investigation
version: 1
owner: sre-team
applies_to_alerts: [LWAdminCommandFailureSpike]
applies_to_incidents: []
applies_to_services: [api-gateway-bff, meta-postgres]
...
related_runbooks: []
external_access_needed: [aws_cloudwatch_logs, pagerduty_admin]
born_from_incident_id: null
shipped_cycle: 35
locked_decisions_consumed: [Q-L7B-1]
---

# Admin - Command Failure Investigation
...
- Alert(s) firing: `LWAdminCommandFailureSpike`
...
admin-cli admin status --dry-run
```
