---
runbook_id: auth/token-flow-broken
version: 1
owner: sre-team
applies_to_alerts: [LWAuthTokenFlowBroken]
applies_to_incidents: []
applies_to_services: [auth-service, api-gateway-bff]
...
- Alert(s) firing: `LWAuthTokenFlowBroken`
