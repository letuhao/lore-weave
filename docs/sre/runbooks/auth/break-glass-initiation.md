---
runbook_id: auth/break-glass-initiation
version: 1
owner: sre-team
applies_to_alerts: [LWAuthBreakGlassRequested]
applies_to_incidents: []
applies_to_services: [auth-service]
...
related_runbooks: []
external_access_needed: [aws_cloudwatch_logs, grafana_auth_dashboard, vault_read_secret_db_prod]
born_from_incident_id: null
shipped_cycle: 35
locked_decisions_consumed: [Q-L7B-1]
---

# Auth - Break Glass Initiation
...
- Alert(s) firing: `LWAuthBreakGlassRequested`
