---
runbook_id: llm-provider/rate-limit-degradation
version: 1
owner: sre-team
applies_to_alerts: [LWLLMProviderRateLimitSpike]
applies_to_incidents: []
applies_to_services: [chat-service]
...
# Llm-Provider - Rate Limit Degradation
...
- Alert(s) firing: `LWLLMProviderRateLimitSpike`
