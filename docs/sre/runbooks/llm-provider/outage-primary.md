---
runbook_id: llm-provider/outage-primary
version: 1
owner: sre-team
applies_to_alerts: [LWLLMProviderOutagePrimary]
applies_to_incidents: []
applies_to_services: [chat-service, translation-service]
last_verified: 1970-01-01
last_verified_by: unassigned
verification_method: stub
next_verification_due: 1970-04-01
severity_hints: [sev1, sev0_if_blast_radius]
dry_run_required_for_destructive: true
related_runbooks: []
external_access_needed: [pagerduty_admin, provider_registry_admin]
born_from_incident_id: null
shipped_cycle: 35
locked_decisions_consumed: [Q-L7B-1]
---

# Llm-Provider - Outage Primary
...
- Alert(s) firing: `LWLLMProviderOutagePrimary`
...
admin-cli llm-provider status --dry-run
```
