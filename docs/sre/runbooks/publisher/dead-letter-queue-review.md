---
runbook_id: publisher/dead-letter-queue-review
version: 1
owner: sre-team
applies_to_alerts: [LWPublisherDLQNonEmpty]
applies_to_incidents: []
applies_to_services: [publisher]
...
# Publisher - Dead Letter Queue Review
...
- Alert(s) firing: `LWPublisherDLQNonEmpty`
...
admin-cli publisher status --dry-run
```
