---
runbook_id: canon/propagation-latency-high
version: 1
owner: sre-team
applies_to_alerts: [LWCanonPropagationLatencyHigh]
applies_to_incidents: []
applies_to_services: [world-service, publisher]
...
# Canon - Propagation Latency High
...
- Alert(s) firing: `LWCanonPropagationLatencyHigh`
