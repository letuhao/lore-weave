---
runbook_id: reality/lifecycle-corruption
version: 1
owner: sre-team
applies_to_alerts: [LWRealityLifecycleCorruption]
applies_to_incidents: []
applies_to_services: [world-service, meta-postgres]
...
related_runbooks: []
external_access_needed: [aws_cloudwatch_logs, grafana_meta_dashboard]
born_from_incident_id: null
shipped_cycle: 35
locked_decisions_consumed: [Q-L7B-1]
---

# Reality - Lifecycle Corruption
...
- Alert(s) firing: `LWRealityLifecycleCorruption`
...
admin-cli reality status --dry-run
```
