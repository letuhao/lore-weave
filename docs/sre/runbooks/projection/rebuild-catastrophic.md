---
runbook_id: projection/rebuild-catastrophic
version: 1
owner: sre-team
applies_to_alerts: [LWProjectionRebuildRequired]
applies_to_incidents: []
applies_to_services: [projection-runner]
...
related_runbooks: []
external_access_needed: [aws_cloudwatch_logs, grafana_pubsub_dashboard]
born_from_incident_id: null
shipped_cycle: 35
locked_decisions_consumed: [Q-L7B-1]
---

# Projection - Rebuild Catastrophic
...
- Alert(s) firing: `LWProjectionRebuildRequired`
...
admin-cli projection status --dry-run
```
