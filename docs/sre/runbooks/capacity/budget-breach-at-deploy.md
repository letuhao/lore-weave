---
runbook_id: capacity/budget-breach-at-deploy
version: 1
owner: sre-team
applies_to_alerts: [LWCapacityDeployBudgetBreach]
applies_to_incidents: []
applies_to_services: [usage-billing-service]
...
related_runbooks: []
external_access_needed: [aws_cloudwatch_logs, grafana_capacity_dashboard]
born_from_incident_id: null
shipped_cycle: 35
locked_decisions_consumed: [Q-L7B-1]
---

# Capacity - Budget Breach At Deploy
...
- Alert(s) firing: `LWCapacityDeployBudgetBreach`
...
admin-cli capacity status --dry-run
```
