...
1. **M7b** (FE rest — model picker (triggers M6 via the glossary delegate), job-row progress polling, AI-`needs_review`/`blocked` badge + verify-flag display, regenerate; **+ the M6 resume/cancel endpoint** for D-WIKI-M6-RESUME) — needs M6+M7a.
