...
**▶ NEXT — wiki FE gap-closure W3→W4 (W5 PO-gated):** per [`2026-06-11-wiki-fe-gap-closure.md`](../plans/2026-06-11-wiki-fe-gap-closure.md): **W3** generate-dialog/sidebar polish (FE-mostly), **W4** job-progress detail (cross-service: BE per-entity outcomes → FE results table). Then the platform epic below once its conflict clears.
