...
**NEXT:** `D-RAWSEARCH-EVAL-CI` (threshold gate + persist + 2nd-book golden + per-band) — last campaign item. (P3-D' closed; P3-B canon orchestrator/FE wiring deferred to D-RAWSEARCH-CANON-WIRING.)
