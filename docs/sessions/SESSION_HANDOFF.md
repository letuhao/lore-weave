...
**NEXT options:** (1) **M5b** publish quality-gate · (2) **M5c** staleness (cross-service) · (3) **M5d** sync-path convergence (TD2) · (4) **M6** human-fix flywheel · (5) **D-TRANSL-EXTRASYSTEM-BUDGET** · (6) **push** (17 commits, needs explicit approval). All 5 original goals delivered; M5b–d/M6 are living-book/flywheel enhancements.
