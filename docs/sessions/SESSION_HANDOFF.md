...
> - **NEXT: E0-2 (book-service self-adopt)** → E0-3 (knowledge) · E0-4 (translation/campaign/composition) · E0-5 (FE panel). **D-E0-LIVE-SMOKE now realizable** (grant→edit→revoke≤60s + trashed→409 across book+glossary; needs real stack + `GLOSSARY_TEST_DB_URL`).
>
