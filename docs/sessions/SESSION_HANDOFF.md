...
**NEXT options:** (1) **M5c** staleness/invalidation (glossary change event → stale flag; cross-service) · (2) **M5d** sync-path convergence (TD2) · (3) **M6** human-fix flywheel · (4) **D-TRANSL-EXTRASYSTEM-BUDGET** · (5) **push** (18 commits, needs explicit approval). All 5 original goals delivered; remaining are living-book/flywheel enhancements.
