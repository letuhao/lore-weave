...
**NEXT:** **P3-B canon-lexical** (speculative — no canon data yet) · `D-RAWSEARCH-EVAL-CI` (threshold gate + persist + 2nd-book golden + per-band). (P3-D' MMR closed — superseded by rerank.)
