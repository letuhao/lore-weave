...
> - **E0-3 deferred rows:**
>   - **D-E0-3-LIVE-SMOKE** — real-stack: owner grants B `edit` on a book with a knowledge project → B reads project + starts extraction; B denied on delete-graph (owner-only); non-grantee 404. **NEXT to run.**
...
> - **NEXT: E0-4 (translation + campaign + composition)** → E0-5 (FE panel).
>
