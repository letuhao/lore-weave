...
> - **NEXT: D-E0-3-CALLER-PAYS-EXTRACTION Phase 2** (full caller-pays capability — designed) → **E0-4b** (campaign) → **E0-4c** (composition) → E0-5 (FE panel). Also pending: **D-E0-4A-LIVE-SMOKE** (translation, deferred).
>
