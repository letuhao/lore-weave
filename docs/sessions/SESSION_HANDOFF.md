...
>
> **✅ B1 COMPLETE (all 4 milestones).** ▶ **NEXT: B2** — Jobs control completeness (P3): `D-JOBS-P3-TRANSLATION-PAUSE`, `D-JOBS-P3-VIDEOGEN-PROVIDER-ABORT`, `D-JOBS-P3-LORE-COMPOSE-TASK-CONTROL` (3 items, M). Then B3 (Job-Control+P5 live-smoke, picks up `D-B0-LIVE-SMOKE` + `D-B1-LIVE-SMOKE`).
