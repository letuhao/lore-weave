...
> - **NEXT: D-E0-3-CALLER-PAYS-EXTRACTION Phase 2** (full caller-pays capability — designed, XL) → **E0-4c** (composition — L/XL, 9 routers, work-anchored authz) → **E0-4b** (campaign, after E0-3 P2) → E0-5 (FE panel). (**D-E0-4A-LIVE-SMOKE** ✅ cleared this session.)
>
