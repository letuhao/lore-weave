...
- Last Updated: 2026-04-19 (session 47 — Cycles 7 + 8a + 8b complete.)
- Updated By: Assistant (session 47 — 4 commits: 7a MMR cosine + 7b Anthropic cache_control + 8a generative rerank + 8b cross-process cache invalidation. knowledge-service 1307 unit pass, chat-service 177 unit pass.)
- Active Branch: `main` (ahead of origin by session 38–47 commits — user pushes manually)
- HEAD: e5aeb96 (Cycle 8a generative rerank); session 47 Cycle 8b about to land
