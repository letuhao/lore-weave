...
| `DP-A` | access-pattern invariants | ~~`A2` `A3` `A18` `A19`~~ · **`A4` `A8` `A11`** | 🟡 **4 of 7 closed.** uncited 7 → 3, unproven 11 → 9; sited 51 → 56, proven 37 → 40 repo-wide. The three left are the architectural ones |
