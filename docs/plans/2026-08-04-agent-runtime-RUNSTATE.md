...
| 2 | `V-METRIC` on a real model | ✅ mechanism **decisive** (20/20 vs 0/20, p=7.25e-12, **quiet failures 0/40**) · ✖ §6.3 rate reduction **`CANNOT DETERMINE`**, 193 turns/arm needed |
