...
| M1.2 · canon ENHANCE (delete onError, restore/undo+showArchived, 412 UI, kind field) | TODO | needs BE-11b |
| M1.3 · BE-11b include_archived + BE-11c MCP restore + compositionEffects Lane-B | TODO | |
