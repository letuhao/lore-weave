...
| `GT5` | discipline lints (forbidden-shape scanners) | `blocking-in-async-lint.py` · `prompt-assembly-discipline-lint.sh` · `raw-sql-lint.py` · `pagination-cap-lint.py` · `logging-discipline-lint.sh` | ⬜ |
