...
- **Seam / note:** Sends motif-chip edits to S2's PlanDrawer via a component S4 owns.
...
|---|---|---|
| S4-A1 · audit current surface (role-play user) | TODO | |
| S4-A2 · PORT/ENHANCE/BUILD decisions per capability | TODO | |
