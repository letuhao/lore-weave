...
| B2b | **27-V2-C2/C4/C5 — MAKE THE PASSES RUN** (was P-01, un-parked per DR-10): the `plan_pass` worker op + job_consumer dispatch + finalize hook · the pass-4 hoist · the artifact-I/O adapters for passes 1–7 | [ ] | |
