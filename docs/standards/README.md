...
| [contracts/frontend-tools.contract.json](../../contracts/frontend-tools.contract.json) | agent→GUI frontend-tool arg schemas + enum rule (cross-language SoT) | ai-gateway `src/mcp/{confirm,ui,propose-edit}-tools.ts` + FE resolvers; edit the JSON BY HAND (regen closed 2026-09-03) |
