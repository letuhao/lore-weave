...
#: then grade".
_MACHINE = re.compile(r"claude|assistant|gpt|llm|auto|tbd|todo|\bme\b", re.I)
...
def labeller_ok(who: str) -> bool:
    """A sheet must be signed by a person. The GRANT makes this load-bearing, not polite."""
...
def _score(path: str) -> int:
    ...
    print(f"[t33-score] labelled by: {by}")
