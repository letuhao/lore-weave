    ...
    async with httpx.AsyncClient(timeout=TURN_TIMEOUT) as client:
        ...
        async def one_repeat(sc, i):
            ...
            try:
                ...
                before = await asyncio.to_thread(snapshot, fx.book_id, fx.project_id, fx.world_id, fx.chapter_id)
                try:
                ...
                after = await asyncio.to_thread(snapshot, fx.book_id, fx.project_id, fx.world_id, fx.chapter_id)
