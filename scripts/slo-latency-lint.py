...
if __name__ == "__main__":
    # `main()` already dispatches --self-test / --selftest (both spellings). The branch
    # that stood here called `_selftest()`, this branch's own copy of the same proof —
    # which the merge replaced with `self_test()`, a strict superset. Left in place it
    # would have raised NameError on the exact flag CI uses to check the gate can go red.
    sys.exit(main())
