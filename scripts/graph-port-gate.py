...
BASELINE = {
    ...
    os.path.join(SCAN_ROOT, "extraction", "glossary_sync.py"),
    os.path.join(SCAN_ROOT, "extraction", "hierarchy_writer.py"),
    os.path.join(SCAN_ROOT, "jobs", "orphan_extraction_source_cleanup.py"),
    os.path.join(SCAN_ROOT, "jobs", "quarantine_cleanup.py"),
    os.path.join(SCAN_ROOT, "jobs", "reconcile_evidence_count.py"),
    os.path.join(SCAN_ROOT, "jobs", "regenerate_summaries.py"),
    os.path.join(SCAN_ROOT, "jobs", "stats_updater.py"),
    os.path.join(SCAN_ROOT, "jobs", "summary_processor.py"),
    os.path.join(SCAN_ROOT, "routers", "internal_admin.py"),
