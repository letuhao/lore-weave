...
from plan_forge.links import build_links_from_events, merge_links, normalize_planner_notes
from plan_forge.llm_client import LMStudioClient
from plan_forge.prompts import (
    ANALYZE_SYSTEM,
    MATERIALIZE_SYSTEM,
    analyze_user_prompt,
...
def analyze_document(
    ...
    *,
    ...
    lm = client or LMStudioClient(io_dir=io_dir)
