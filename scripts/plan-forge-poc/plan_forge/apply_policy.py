...
from plan_forge.eval_fidelity import evaluate_spec_fidelity
from plan_forge.interpret import interpret_feedback, is_lazy_handoff
from plan_forge.refine import AcceptResult, accept_refine, refine_spec
...
def apply_handoff_chain(
    ...
    *,
    ...
    for _ in range(max_rounds):
        ...
        if not gaps:
            break
        from plan_forge.interpret import _build_revision_from_gap
