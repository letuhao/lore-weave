...
fn v1_engine_default_digest_is_pinned() {
    ...
    assert_eq!(
        hex(&d.0),
        "807d5b5213f0707ff1e0f2e359d1b22463ce074d914ab98646440a4f62f4fe01",
        "the engine-default ruleset digest moved — a rules value, the canonical \
         encoding, or the schema version changed. That is a rules change for \
         EVERY reality; confirm it was intended before repinning."
    );
}
