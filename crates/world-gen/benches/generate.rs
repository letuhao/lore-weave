...
use world_gen::{CreativeSeed, Projection, RenderStyle, RenderTheme, WorldScale, generate};
...
fn bench_render(c: &mut Criterion) {
    ...
    group.bench_function("relief_gigaplanet_2048", |b| {
        b.iter(|| relief_image(black_box(&map), 2048, 2048, RenderStyle::Realistic, Projection::Equirectangular, &RenderTheme::default()));
    });
    group.finish();
}
