...
/// **v4.1a**: templated zone — a sub-region of a plate that has its own
/// polygon shape generated by the dispatcher at `depth = 1`. Climate and
/// drainage will use the zone's polygon (instead of the Voronoi seed
/// point) once v4.1b/c migration ships.
#[derive(Debug, Clone)]
pub struct Zone {
    pub id: usize,
    pub plate_id: usize,
