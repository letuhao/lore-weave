...
- `.github/skills/ddd-practices/SKILL.md`
- `.github/skills/ddd-practices/references/SOURCE-MAP.md`
...
- write each child directly under `.github/skills/<prefix>-<child-scope>/`
...
- no writes to the current agent `.github/skills`
...
- save to `.github/skills/platform-operator/`
...
- confirm the resolved target path would stay under the resolved output root (`.github/skills` by default, or `--path` when present)
